...
```{r}
id <- "E-GEOD-71783"
exonCELs <-list.celfiles("C:/workspace/HighThroughput/Project/AHTA-Project/GEOD-71783/")
data.raw <-read.celfiles(paste(rep("C:/workspace/HighThroughput/Project/AHTA-Project/GEOD-71783/",length(exonCELs)),exonCELs,sep=""))
...
```{r}
sdrf <- read.delim("C:/workspace/HighThroughput/Project/AHTA-Project/GEOD-71783/E-GEOD-71783.sdrf.txt")
...
```{r}
id <- "E-GEOD-71781"
exonCELs <-list.celfiles("./GEOD-71781/")
data.raw <-read.celfiles(paste(rep("./GEOD-71781/",length(exonCELs)),exonCELs,sep=""))
...
```{r}
sdrf <- read.delim("C:/workspace/HighThroughput/Project/AHTA-Project/GEOD-71781/E-GEOD-71781.sdrf.txt")
print(sdrf[,c("Source.Name","Comment..Sample_title.","Array.Design.REF")])
```
