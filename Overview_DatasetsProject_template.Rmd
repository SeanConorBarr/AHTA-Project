...
```{r}
id <- "E-GEOD-71783"
exonCELs <-list.celfiles("./GEOD-71783/")
data.raw <-read.celfiles(paste(rep("./GEOD-71783/",length(exonCELs)),exonCELs,sep=""))
...
```{r}
sdrf <- read.delim("./GEOD-71783/E-GEOD-71783.sdrf.txt")
...
```{r}
sdrf <- read.delim("./GEOD-71781/E-GEOD-71781.sdrf.txt")
print(sdrf[,c("Source.Name","Comment..Sample_title.","Array.Design.REF")])
```
